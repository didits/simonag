...
public class DashboardKomersialFragment extends Fragment {
    ...
    private void setupRecyclerView(RecyclerView recyclerView) {
        ...
        Collections.sort(employees, new Comparator<Dashboard>() {
            ...
            public int compare(Dashboard dashboard, Dashboard t1) {
                Integer id1 = (int)dashboard.getPersentase_komersial();
                Integer id2 = (int)t1.getPersentase_komersial();
    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            if((int) mValues.get(position).getPersentase_komersial()<0)
                holder.progress_nilai.setProgressTextVisibility(NumberProgressBar.ProgressTextVisibility.Invisible);
            holder.progress_nilai.setProgress((int) mValues.get(position).getPersentase_komersial());
