...
public class DataProgramAdapter extends RecyclerView.Adapter<PenghuniAdapter.ViewHolder> {

    Context context;
    List<Penghuni> penghunis;
    EditHapusInterface listener;

    public DataProgramAdapter(Context context, List<Penghuni> penghunis, EditHapusInterface listener) {
