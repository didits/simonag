...
public class DataAktivitasAdapter extends RecyclerView.Adapter<PenghuniAdapter.ViewHolder> {

    Context context;
    List<Penghuni> penghunis;
    EditHapusInterface listener;

    public DataAktivitasAdapter(Context context, List<Penghuni> penghunis, EditHapusInterface listener) {
